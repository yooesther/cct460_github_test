...
//                            } );   
                jQuery( '#wpbc_bookingtimeline_type,#wpbc_bookingtimeline_view_days_num,#wpbc_bookingtimeline_header_title,#wpbc_bookingtimeline_scroll_start_date_active,#wpbc_bookingtimeline_scroll_month,#wpbc_bookingtimeline_scroll_day').on( 'change', function(){      // Booking Resource Selectbox Change value
                    wpbc_set_shortcode();
                });                     
