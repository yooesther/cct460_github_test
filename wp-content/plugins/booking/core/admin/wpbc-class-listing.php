...
class WPBC_Booking_Listing_Table {
    ...
    public function header( $is_free ) {
        ...
        <div class="row wpbc-listing-header wpbc_selectable_head">
            ...
            <div class="wpbc-listing-collumn col-sm-6 col-xs-6 text-center wpbc_column_4"><?php _e('Booking Data', 'booking'); ?></div>
            ...
            <?php if ( $is_free ) { ?>
            <div class="wpbc-listing-collumn col-sm-1 hide-sm text-center wpbc_column_6"><?php _e('Actions', 'booking'); ?></div>
            <?php } ?>
        </div>
        <?php
    }
    ...
    public function show_row( $row_data, $is_free ) {
      ...
      ?><div id="booking_mark_<?php echo $row_data[ 'id' ]; ?>"  
        ...
        ?><div id="booking_row_<?php echo $row_data[ 'id' ]; ?>" class="row wpbc_row clearfix-height wpbc-listing-row <?php echo $row_data[ 'css' ]; ?><?php echo $is_free ? ' wpbc_free' : ''; ?>"><?php 
            ...
            // Data
            ?><div class="wpbc-listing-collumn col-sm-6 col-xs-12 wpbc-text-justify field-content wpbc_column_4">
            ...
            // Actions
            ?><div class="wpbc-listing-collumn col-sm-<?php echo $is_free ? '1' : '10'; ?> col-xs-12 text-left field-action-buttons booking-actions wpbc_column_6"><?php  
