            ...
            switch ( $tab['type'] ) {
                ...
                case 'button':                              // Button
                   ?><div class="clear-for-mobile"></div><input 
                            ...
                            onclick="if (typeof document.forms['<?php echo $tab['form']; ?>'] !== 'undefined'){ document.forms['<?php echo $tab['form']; ?>'].submit(); } else { wpbc_admin_show_message( '<?php echo ' <strong>', __('Error', 'booking') ,'!</strong> ', __('Form', 'booking') , ' <strong>' , $tab['form'] , '</strong> ', __('does not exist', 'booking'); ?>.', 'error', 10000 ); }" 
                            /><?php
                break;
