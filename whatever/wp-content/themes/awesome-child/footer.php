	...
	<footer id="colophon" class="site-footer" role="contentinfo">
	  ...
	  <p class="colophon">
	  	...
	  	<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'yuuta' ) ); ?>"><?php printf( __( 'Proudly powered by %s', 'yuuta' ), 'WordPress' ); ?></a><br />
			<?php printf( __( 'OG Theme: %1$s by %2$s', 'yuuta' ), 'Yuuta', '<a href="https://felixdorner.de" rel="designer">Felix Dorner</a>' ); ?>
			<?php printf( __( '<br />New Theme: %1$s by %2$s', 'Tech-Ass' ), 'Yuuta', '<a href="https://almojuela.com" rel="designer">Cheryl Eh</a>' ); ?>
	  </p>
